...
----
+
Estas acciones se incluyen en las últimas novedades https://mysupport.netapp.com/cloudontap/iampolicies["Política de Cloud Manager"^]. Los nuevos sistemas implementados desde Cloud Central de NetApp incluyen automáticamente estos permisos.
